...
const EXTRA_GROUPS: SymbolGroup[] = [
  {
    id: "czechSlovak",
    symbols: uniq([
      "a", "á", "A", "Á", "b", "B", "c", "č", "C", "Č", "d", "ď", "D", "Ď", "e", "é", "E", "É",
      "ě", "Ě", "f", "F", "g", "G", "h", "H", "i", "í", "I", "Í", "j", "J", "k", "K", "l", "L",
      "m", "M", "n", "ň", "N", "Ň", "o", "ó", "O", "Ó", "p", "P", "q", "Q", "r", "ř", "R", "Ř",
      "s", "š", "S", "Š", "t", "ť", "T", "Ť", "u", "ú", "U", "Ú", "ů", "Ů", "v", "V", "w", "W",
      "x", "X", "y", "ý", "Y", "Ý", "z", "ž", "Z", "Ž",
    ]),
  },
  {
  ...
  },
  {
    id: "slavicLatin",
    symbols: uniq([
      "č", "Č", "ć", "Ć", "ď", "Ď", "đ", "Đ", "ě", "Ě", "ł", "Ł", "ń", "Ń", "ň", "Ň",
      "ř", "Ř", "ś", "Ś", "š", "Š", "ť", "Ť", "ů", "Ů", "ź", "Ź", "ż", "Ż", "ž", "Ž",
    ]),
  },
  {
    id: "diacritics",
    symbols: uniq([
      ...
      "í", "ì", "î", "ï", "ī", "į", "ĩ", "Í", "Ì", "Î", "Ï", "Ī", "Į", "Ĩ",
      "ó", "ò", "ô", "ö", "õ", "ō", "ő", "ø", "Ó", "Ò", "Ô", "Ö", "Õ", "Ō", "Ő", "Ø",
      "ú", "ù", "û", "ü", "ū", "ů", "ű", "ũ", "Ú", "Ù", "Û", "Ü", "Ū", "Ů", "Ű", "Ũ",
      "ý", "ÿ", "ŷ", "Ý", "Ÿ", "Ŷ", "ç", "Ç", "ñ", "Ñ", "ş", "Ş", "ğ", "Ğ", "ı", "İ",
